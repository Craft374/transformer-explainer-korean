...
class GPT(nn.Module):
    ...
    def from_pretrained(cls, model_type, override_args=None):
        assert model_type in {'gpt2', 'gpt2-medium', 'gpt2-large', 'gpt2-xl', 'skt/kogpt2-base-v2'}
        ...
        config_args = {
            ...
            'skt/kogpt2-base-v2': dict(n_layer=12, n_head=12, n_embd=768, vocab_size=51200), # KoGPT2, 125M params
        }[model_type]
        print("forcing block_size=1024, bias=True")
        config_args.setdefault('vocab_size', 50257) # 50257 for GPT-2 checkpoints
